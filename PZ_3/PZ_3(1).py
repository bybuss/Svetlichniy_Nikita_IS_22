# Проверить лежит ли точка (х, у) внутри прямоугольника с левой верхней вершиной (x1, y1) и нижней правой (x2, y2)
...
#Обработка данных, введенных пользователем (8-48 строчки)
while type(x) != int:
    try:
        x = int(x)
    except ValueError:
